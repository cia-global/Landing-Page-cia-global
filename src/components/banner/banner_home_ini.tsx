...
export default function BannerHomeIni() {
  return (
    ...
    <section className="relative bg-gray-50 text-white pt-24 md:pt-32  lg:py-20 overflow-hidden">
        <div className="absolute lg:top-0 lg:right-0 lg:w-1/2 lg:h-full lg:bg-gray-950 " />
        <div className="hidden lg:block absolute top-0 left-1/2 w-20 h-full bg-gradient-to-r from-gray-50 to-gray-950"></div>
      <BackgroundElements />
      ...
      <div className="relative z-10  mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-0 items-center ">
          ...
          <div className="space-y-5 sm:space-y-5 md:px-16 px-8 ">
            ...
            <div className="flex justify-center">
              <img
                ...
                fetchPriority="high"
                className="w-72 sm:w-72 md:w-80 lg:w-80 xl:w-96 object-contain drop-shadow-2xl"
              />
            </div>
            ...
            {/* Descripción */}
            <div className="px-6 lg:px-2 xl:px-16">
          ...
          <div className=" flex flex-col items-center xl:-mt-8 lg:-mt-8 sm:mt-12 bg-gray-950 lg:bg-gray-950/0">
              <div className="lg:hidden w-full h-8 bg-gradient-to-b from-gray-50 to-transparent z-10"></div>

              <div className=" relative w-full max-w-[22rem] sm:max-w-sm md:max-w-sm lg:max-w-xl h-[400px] sm:h-[460px] lg:h-[620px]">  
                <div className=''><ColombiaMap/></div> 
              </div>
              <div className="absolute  bottom-4 left-3 md:left-6 lg:left-[60%] ">
              <div className="relative inline-block">
                ...
                {/* Caja principal */}
                <div className="bg-black border border-white rounded-2xl px-6 sm:px-8 py-2 sm:py-5 shadow-lg">
                  <p className="text-gray-300 tracking-[0.2em] text-sm font-medium">
                    PRESENCIA NACIONAL
                  </p>
                  <h2 className="text-yellow-400 text-md sm:text-2xl font-extrabold mt-1">
                    +25 SEDES ACTIVAS
                  </h2>
                </div>
              </div>
