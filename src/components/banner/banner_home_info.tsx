...
const BannerInfo = () => {
  const discountCards: DiscountCard[] = [
    ...
    },
    {
      ...
      description: 'Si aceptas la infracción y realizas el curso dentro de los 11 días hábiles.',
      icon: <Camera size={24} />,
    ...
    },
    {
      ...
      description: 'Si realizas el curso entre el día 12 y el día 26 hábil después de la notificación.',
