        ...
        <div className="grid sm:grid-cols-2 gap-6 mb-6">
          ...
          >
            <div className={`w-14 h-14 rounded-full flex items-center justify-center transition-colors ${
              mostrarBuscador ? "bg-amber-200" : "bg-amber-100 group-hover:bg-amber-200"
            }`}>
            ...
            <span className="mt-auto inline-flex items-center gap-1 text-amber-600 text-xs font-semibold">
