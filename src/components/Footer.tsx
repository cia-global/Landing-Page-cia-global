    ...
    <footer className="bg-gray-950 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-400">info@vialseg.co</span>
              </div>
              <div className="flex items-center">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link 
                  to="/curso-comparendo-bucaramanga"
                className="text-gray-400 hover:text-white transition-colors">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4">Nuestras Sedes</h3>
            <ul className="space-y-2"> 
              <li>
                <Link 
                  to="/curso-comparendo-bucaramanga"
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2026 Cursos Comparendos de Colombia. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
