...
import SedesFlorencia from "./SedesFlorencia";
...
export default function FlorenciaCity() {
  const faqs = [
    {
      pregunta: "¿Cuánto dura el curso de comparendos en Florencia?",
      respuesta:
        "El curso pedagógico para infractores de tránsito en Florencia tiene una duración de 2 horas. Es un proceso rápido y sencillo que puedes completar en una sola sesión presencial en nuestra sede.",
    },
    {
    ...
    {
      pregunta: "¿Dónde se realiza el curso en Florencia?",
      respuesta:
        "Nuestra sede en Florencia está ubicada en un punto de fácil acceso en la ciudad. Al agendar tu cita recibirás la dirección exacta y los horarios disponibles para que puedas planificar tu visita.",
    },
    {
  ...
  const beneficios = [
    ...
    { icon: <MapPin className="w-6 h-6" />, titulo: "Sede en Florencia", desc: "Atención presencial en la ciudad" },
  ...
  const pasos = [
    ...
    { num: "02", titulo: "Asiste a la sede", desc: "Preséntate en nuestra sede en Florencia con tu documento de identidad y el número del comparendo." },
  ...
  return (
    <>
      <Helmet>
        <title>Curso de comparendo en Florencia con 50% de descuento | Agenda hoy</title>
        <meta
          name="description"
          content="Realiza tu curso de comparendos en Florencia y obtén hasta un 50% de descuento en tu multa. Curso certificado, duración 2 horas, atención presencial. ¡Agenda hoy!"
        />
        <meta
          name="keywords"
          content="curso comparendo florencia, descuento comparendo florencia, curso infractores florencia, reducir multa transito florencia, curso pedagogico florencia"
        />
        <link rel="canonical" href="https://www.pagocursoscomparendos.com/cities/florencia" />
        <meta name="robots" content="index,follow" />
        <meta property="og:title" content="Curso de comparendo en Florencia con 50% de descuento" />
        <meta property="og:description" content="Obtén hasta un 50% de descuento en tu comparendo en Florencia. Curso certificado de 2 horas. ¡Agenda hoy!" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.pagocursoscomparendos.com/cities/florencia" />
      </Helmet>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-10">
              ...
              <div className="flex-1 flex flex-col sm:items-center md:items-center lg:items-start sm:text-center md:text-center lg:text-left space-y-6">
                ...
                <span className="inline-flex items-center gap-2 bg-yellow-400/20 border border-yellow-400/30 text-yellow-300 px-4 py-1.5 rounded-full text-sm font-semibold ">
                  <MapPin className="w-4 h-4" /> Florencia, Caquetá
                </span>
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight sm:text-center lg:text-left">
                  ...
                  <span className="text-yellow-400">Florencia</span>{" "}
                  con descuento
                </h1>

                <p className="text-lg text-gray-300 leading-relaxed max-w-xl sm:text-center">
                  Si tienes un comparendo en Florencia, puedes obtener hasta un{" "}
          ...
          <div className="max-w-5xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500 max-w-xl mx-auto">
                Somos una institución certificada con años de experiencia en Florencia
              </p>
            </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-5xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500">5 pasos simples para obtener tu descuento en Florencia</p>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-3xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500">Todo lo que necesitas saber sobre el curso en Florencia</p>
            </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-3xl mx-auto px-6 lg:px-8">
            <h2 className="text-2xl font-extrabold text-gray-900 mb-6">
              Curso de comparendos en Florencia: todo lo que debes saber
            </h2>
            <div className="prose prose-gray max-w-none space-y-4 text-gray-600 leading-relaxed">
              <p>
                Si recibiste un comparendo en Florencia o en cualquier municipio del
                departamento de Caquetá, tienes la posibilidad de reducir hasta el 50%
              ...
              <p>
                ...
                dos sedes en Florencia donde ofrecemos este curso de manera presencial,
              ...
              <p>
                El <strong>descuento comparendo Florencia</strong> aplica tanto para
              ...
              <p>
                Agendar tu <strong>curso infractores Florencia</strong> es muy sencillo.
                Solo debes ingresar a nuestra plataforma, seleccionar la ciudad de
                Florencia, elegir la fecha y hora disponible, y completar tus datos
              ...
              <p>
                No esperes más para resolver tu situación de tránsito en Florencia.
                ...
                de las vías de Florencia y Caquetá un lugar más seguro para todos.
              </p>
            </div>
            ...
            <div className="mt-10 bg-gradient-to-br from-gray-950 via-[#253688] to-gray-950 rounded-3xl p-8 text-center text-white">
              ...
              <p className="text-gray-300 mb-6 text-sm">Agenda tu curso en Florencia en menos de 2 minutos</p>
              <Link
                to="/appointment?city=florencia"
